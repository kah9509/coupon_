...
if ( !class_exists('IamportPaymentShortcode') ) {
	...
	class IamportPaymentShortcode {
		...
		public function init() {
			...
			wp_register_style('iamport-payment-shortcode-css', plugins_url('../assets/css/iamport-payment-shortcode.css', __FILE__));
			wp_enqueue_style('iamport-payment-shortcode-css');
			
			wp_register_script('iamport-bundle-main-js', plugins_url('../dist/bundle-main.js', __FILE__), array('jquery'), '20171228');
